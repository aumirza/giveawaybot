...
from handlers import admin_start_handler , clear_all_handler,clear_redeemed_handler,clear_unredeemed_handler,display_all_handler
...
async def main():
    ...
    bot_client.add_handler(MessageHandler(display_all_handler, filters.command("display_all") & filters.user(admins)))
